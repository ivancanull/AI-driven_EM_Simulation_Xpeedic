...
class unet_deeper(nn.Module):
    ...
    def __init__(self, in_channels, mid_channels, out_channels):
        ...
        assert len(mid_channels) == 9

        self.in_channels = in_channels
        self.out_channels = out_channels
        self.kernel_size = math.floor(self.out_channels ** 1 / 3)

        self.transconv6_shape = self.out_channels // 2
        self.transconv5_shape = self.transconv6_shape // 2
        self.transconv4_shape = self.transconv5_shape // 2
        self.transconv3_shape = self.transconv4_shape // 2
        ...
        self.unflatten = nn.Unflatten(-1, (-1, 7))
        ...
        self.up3 = up(mid_channels[4], mid_channels[5], self.transconv4_shape)
        self.up4 = up(mid_channels[5], mid_channels[6], self.transconv5_shape)
        self.up5 = up(mid_channels[6], mid_channels[7], self.transconv6_shape)
        self.up6 = up(mid_channels[7], mid_channels[8], self.out_channels)
        self.out = outconv(mid_channels[8], 2, self.out_channels)
